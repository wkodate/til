...
public class HourlyTipsExercise extends ExerciseBase {
    ...
    public static class MyHourlyTips extends ProcessWindowFunction<
            TaxiFare,                  // input type
        ...
        @Override
        public void process(Long key, Context context, Iterable<TaxiFare> events, Collector<Tuple3<Long, Long, Float>> out) {
            float sum = 0;
